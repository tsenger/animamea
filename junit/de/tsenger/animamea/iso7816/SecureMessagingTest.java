...
public class SecureMessagingTest {
	...
	byte[] plain_cmd1_AES = Hex
			.decode("002281b60f830d44455445535444564445303139");
	byte[] crypt_cmd1_AES = Hex
			.decode("0c2281b61d871101a7bb8f230fff9221162ad673b9f319a88e08d8713e9b7a600b4900");

	byte[] crypt_resp1 = Hex
			.decode("8709019ff0ec34f9922651990290008e08ad55cc17140b2ded9000");
	byte[] plain_resp1 = Hex.decode("60145f019000");

	byte[] plain_cmd1 = Hex.decode("00a4020c02011e");
	byte[] crypt_cmd1 = Hex
			.decode("0ca4020c158709016375432908c044f68e08bf8b92d635ff24f800");
	...
	/**
	 * Test method for
	 * {@link de.tsenger.animamea.iso7816.SecureMessaging#wrap(javax.smartcardio.CommandAPDU)}
	 * .
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Test method for
	 * {@link de.tsenger.animamea.iso7816.SecureMessaging#unwrap(javax.smartcardio.ResponseAPDU)}
	 * .
	 * 
	 * @throws Exception
	 */
	...
	public void testWrapAES() throws Exception {
		sm = new SecureMessaging(new AmAESCrypto(), kenc_AES, kmac_AES,
