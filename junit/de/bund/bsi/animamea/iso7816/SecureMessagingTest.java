...
public class SecureMessagingTest {
	...
	/**
	 * Test method for {@link de.bund.bsi.animamea.iso7816.SecureMessaging#wrap(javax.smartcardio.CommandAPDU)}.
	 * @throws Exception 
	 */
	@Test
	public void testWrap() throws Exception {
		sm = new SecureMessaging("DES", kenc, kmac, initialSSC1);
		CommandAPDU pc = sm.wrap(capdu);
		System.out.println(HexString.bufferToHex(pc.getBytes()));
		assertTrue(Arrays.areEqual(crypt_cmd1, pc.getBytes()));
	}

	/**
	 * Test method for {@link de.bund.bsi.animamea.iso7816.SecureMessaging#unwrap(javax.smartcardio.ResponseAPDU)}.
	 * @throws Exception 
	 */
	@Test
	public void testUnwrap() throws Exception {
		sm = new SecureMessaging("DES", kenc, kmac, initialSSC2);
		ResponseAPDU ur = sm.unwrap(rapdu);
		System.out.println(HexString.bufferToHex(ur.getBytes()));
