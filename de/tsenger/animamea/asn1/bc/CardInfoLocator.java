...
import de.tsenger.animamea.asn1.CardInfoLocatorInterface;
...
public class CardInfoLocator implements CardInfoLocatorInterface{
	...
	/* (non-Javadoc)
	 * @see de.tsenger.animamea.asn1.CardInfoLocatorInterface#getOID()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.tsenger.animamea.asn1.CardInfoLocatorInterface#getUrl()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.tsenger.animamea.asn1.CardInfoLocatorInterface#getFileID()
	 */
	@Override
