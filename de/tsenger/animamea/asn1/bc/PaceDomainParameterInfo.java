...
import de.tsenger.animamea.asn1.PaceDomainParameterInfoInterface;
...
public class PaceDomainParameterInfo implements PaceDomainParameterInfoInterface{
	...
	/* (non-Javadoc)
	 * @see de.tsenger.animamea.asn1.PaceDomainParameterInfoInterface#getProtocolString()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.tsenger.animamea.asn1.PaceDomainParameterInfoInterface#getDomainParameter()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.tsenger.animamea.asn1.PaceDomainParameterInfoInterface#getParameterId()
	 */
	@Override
