...
import de.tsenger.animamea.asn1.ChipAuthenticationDomainParameterInfoInterface;
...
public class ChipAuthenticationDomainParameterInfo implements ChipAuthenticationDomainParameterInfoInterface{
	...
	/* (non-Javadoc)
	 * @see de.tsenger.animamea.asn1.ChipAuthenticationDomainParameterInfoInterface#getProtocolString()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.tsenger.animamea.asn1.ChipAuthenticationDomainParameterInfoInterface#getDomainParameter()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.tsenger.animamea.asn1.ChipAuthenticationDomainParameterInfoInterface#getKeyId()
	 */
	@Override
	public int getKeyId() {
