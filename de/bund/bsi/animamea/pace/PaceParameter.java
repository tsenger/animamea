...
import de.bund.bsi.animamea.iso7816.SecureMessaging;
...
public class PaceParameter {
	...
	private final PaceDomainParameterInfo dpi = null;
	private final CertificateHolderAuthorizationTemplate chat = null;
	private final byte[] kmac = null;
	private final byte[] kenc = null;
	private final byte[] authToken = null;
	private final SecureMessaging sm = null;
	...
	private void extractDomainParameter(PaceInfo pi) {
		...
		else if (dhp!=null) parameterType = 1;
			
//		SecureRandom random = new SecureRandom();
//		DHKeyGenerationParameters dhKGP = new DHKeyGenerationParameters(random, dhp); 
//		CipherKeyGenerator cipherGen = new CipherKeyGenerator();
//		cipherGen.init(dhKGP);

	
	}
	
	private DHParameters modp1024_160() {
		BigInteger p = new BigInteger("B10B8F96A080E01DDE92DE5EAE5D54EC52C99FBCFB06A3C6" +
				"9A6A9DCA52D23B616073E28675A23D189838EF1E2EE652C0" +
				"13ECB4AEA906112324975C3CD49B83BFACCBDD7D90C4BD70" +
				"98488E9C219A73724EFFD6FAE5644738FAA31A4FF55BCCC0" +
				"A151AF5F0DC8B4BD45BF37DF365C1A65E68CFDA76D4DA708" +
				"DF1FB2BC2E4A4371",16);
		BigInteger g = new BigInteger("A4D1CBD5C3FD34126765A442EFB99905F8104DD258AC507F" +
				"D6406CFF14266D31266FEA1E5C41564B777E690F5504F213" +
				"160217B4B01B886A5E91547F9E2749F4D7FBD7D3B9A92EE1" +
				"909D0D2263F80A76A6A24C087A091F531DBF0A0169B6A28A" +
				"D662A4D18E73AFA32D779D5918D08BC8858F4DCEF97C2A24" +
				"855E6EEB22B3B2E5",16);
		BigInteger q = new BigInteger("F518AA8781A8DF278ABA4E7D64B7CB9D49462353",16);
		return new DHParameters(p,g,q); 
	}
	
	private DHParameters modp2048_224() {
		BigInteger p = new BigInteger("AD107E1E9123A9D0D660FAA79559C51FA20D64E5683B9FD1" +
		...
		BigInteger g = new BigInteger("AC4032EF4F2D9AE39DF30B5C8FFDAC506CDEBE7B89998CAF" +
		...
		BigInteger q = new BigInteger("801C0D34C58D93FE997177101F80535A4738CEBCBF389A99" +
				"B36371EB",16);
		return new DHParameters(p,g,q);
	}
	
	private DHParameters modp2048_256() {
		BigInteger p = new BigInteger("87A8E61DB4B6663CFFBBD19C651959998CEEF608660DD0F2" +
		...
		BigInteger g = new BigInteger("3FB32C9B73134D0B2E77506660EDBD484CA7B18F21EF2054" +
		...
		BigInteger q = new BigInteger("8CF83642A709A097B447997640129DA299B1A47D1EB3750B" +
				"A308B0FE64F5FBD3",16);
		return new DHParameters(p,g,q);
	}
